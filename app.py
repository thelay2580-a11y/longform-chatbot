...
def build_longform_prompt(topic: str, source_text: str, minutes: int, tone: str, audience: str):
    return f"""
...
def generate():
    ...
    prompt = build_longform_prompt(topic, source_text, minutes, tone, audience)
